...
export default function SuccessPage() {
    ...
    return (
        <div className="bg-[#F5F5F5] min-h-screen flex items-center justify-center px-6">

            <motion.div
                initial={{ opacity: 0, scale: 0.96 }}
                animate={{ opacity: 1, scale: 1 }}
                transition={{ duration: 0.4 }}
                className="text-center max-w-md w-full bg-white border border-gray-200 p-10"
            >
                ...
                <motion.div
                    ...
                    className="w-16 h-16 mx-auto mb-8 rounded-full bg-[#526FAE]/10 flex items-center justify-center"
                >
